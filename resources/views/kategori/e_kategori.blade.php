                    ...
                    <div class="card pt-2">
                        <div class="card-body">
                            ...
                            <form action="{{ route('kategori.update', $kategori->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                @method('patch')
                                <h6>Nama Kategori</h6>
                                <input type="text" name="category_name" value="{{ $kategori->category_name }}" placeholder="Nama Kategori" class="form-control">
                                <br>
                                <h6>Pilih Gambar Kategori</h6>
                                <img src="{{ asset('global/kategori') }}/{{ $kategori->category_image }}" width="100px">
                                <input type="hidden" name="foto" value="{{ asset('global/kategori') }}/{{ $kategori->category_image }}">
                                <input type="file" name="category_image" class="input-control"  class="file-upload">
                                <br>
                                <br>
